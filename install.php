        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            ...
            <?php if (isset($_GET['finish'])) : ?>
                ...
                <div class="typecho-install-body">
                    ...
                    <a target="_blank" href="https://www.xggm.top">Typecho(1.1.17.10.30) - XG.GM定制版</a>
                    </div>
            ...
            <?php
                                    ...
                                    try {
                                        ...
                                        /** 初始内容 */
                                        $installDb->query($installDb->insert('table.contents')->rows(array('title' => _t('欢迎使用 Typecho-XG.孤梦定制版'), 'slug' => 'start', 'created' => Typecho_Date::time(), 'modified' => Typecho_Date::time(),
                                        ...
                                        /** 初始评论 */
                                        $installDb->query($installDb->insert('table.comments')->rows(array('cid' => 1, 'created' => Typecho_Date::time(), 'author' => 'XG.孤梦', 'ownerId' => 1, 'url' => 'http://www.xggm.top',
                                        'ip' => '127.0.0.1', 'agent' => $options->generator, 'text' => '欢迎使用Typecho-XG.孤梦定制版', 'type' => 'comment', 'status' => 'approved', 'parent' => 0)));
