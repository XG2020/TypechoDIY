...
<div class="main">
    <div class="body container">
        ...
        <div class="row typecho-page-main">
            ...
            <p><a href="https://cravatar.cn/emails/" title="<?php _e('点击修改头像'); ?>"><?php echo '<img class="profile-avatar" src="' . Typecho_Common::gravatarUrl($user->mail, 220, 'X', 'mm', $request->isSecure()) . '" alt="' . $user->screenName . '" />'; ?></a></p>
                <h2><?php $user->screenName(); ?></h2>
                <p>用户名：<?php $user->name(); ?></p>
