...
class Widget_Users_Profile extends Widget_Users_Edit implements Widget_Interface_Do
{
    ...
    public function profileForm()
    {
        ...
        /** 个性签名 */
        $sign = new Typecho_Widget_Helper_Form_Element_Text('sign', NULL, NULL, _t('个性签名'), _t('添加个性签名，用于前台显示'));
        $form->addInput($sign);

        /** 自定义作者背景图片 */
        $bgimg = new Typecho_Widget_Helper_Form_Element_Text('bgimg', NULL, NULL, _t('作者背景图片'), _t('自定义作者背景图片，用于前台显示'));
        $form->addInput($bgimg);
    ...
    public function updateProfile()
    {
        ...
        /** 取出数据 */
        $user = $this->request->from('mail', 'sign', 'bgimg', 'screenName', 'url');
