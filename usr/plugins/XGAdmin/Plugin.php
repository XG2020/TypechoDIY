...
class XGAdmin_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Typecho_Plugin::factory('admin/header.php')->header_1011 = array('XGAdmin_Plugin', 'renderHeader');
        Typecho_Plugin::factory('admin/footer.php')->end_1011 = array('XGAdmin_Plugin', 'renderFooter');
        if (file_exists("var/Widget/Menu.php")) {
            //挂载menu.php
            rename("var/Widget/Menu.php", "var/Widget/Menu.php.bak");
            copy("usr/plugins/XGAdmin/var/Widget/Menu.php", "var/Widget/Menu.php");
        }
...
//        $activatedPlugins = json_decode(json_encode($activatedPlugins),true);
    ...
    public static function renderHeader($hed,$new)
    {
        ...
        if (!Typecho_Widget::widget('Widget_User')->hasLogin()) {
            ...
            <link rel="stylesheet" href="' . $url . 'css/font_1159885_cgwht2i4i9m.css">
            <link rel="stylesheet" href="' . $url . 'css/font_2348538_kz7l6lrb8h.css">
